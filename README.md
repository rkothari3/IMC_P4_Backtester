...
[![Build Status](https://github.com/rkothari3/imc-prosperity-4-backtester/workflows/Build/badge.svg)](https://github.com/rkothari3/imc-prosperity-4-backtester/actions/workflows/build.yml)
...
# Requires the value passed to `--data` to be a path to a directory that is similar in structure to prosperity4bt/resources/
